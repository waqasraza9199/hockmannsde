...
class RHWebBrandSliderCmsElementResolver extends AbstractCmsElementResolver
{
    private const PRODUCT_SLIDER_ENTITY_FALLBACK = 'rhweb-brand-slider-entity-fallback';
    private const STATIC_SEARCH_KEY = 'rhweb-brand-slider';

    public function getType(): string
    {
        return 'rhweb-brand-slider';
    }
    ...
    {
        $config = $slot->getFieldConfig();
        $slider = new RHWebBrandSliderStruct();
        $slot->setData($slider);
    ...
    private function enrichFromSearch(RHWebBrandSliderStruct $slider, ElementDataCollection $result, string $searchKey): void
    {
