...
namespace TcinnThemeWareElectric\CustomFields;
...
class CustomFieldUpdater
{
    ...
    public function remove()
    {
        $criteria = (new Criteria())
            ->addFilter(new ContainsFilter('name', 'twt_electric_pro_custom_field__'));
        ...
        $criteria = (new Criteria())
            ->addFilter(new ContainsFilter('name', 'twt_electric_pro_custom_field_set__'));
    ...
    private function getCustomFieldSetStorage()
    {
        ...
        $customFieldSetStorageFiles = glob(
            "{$this->pluginPath}/CustomFields/CustomFieldSets/twt_*.json"
        );
